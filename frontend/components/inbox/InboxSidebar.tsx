...
import { Search, Bot, MessageSquare, ShieldCheck } from 'lucide-react';
      ...
      <div className="flex-1 bg-white border border-slate-200/60 rounded-[2rem] shadow-sm flex flex-col overflow-hidden">
        ...
        <div className="p-6 pb-2 space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">WhatsApp Chats</h2>
                  ...
                  <div className="flex justify-between items-baseline mb-0.5">
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <span className={cn(
                        ...
                        {contact.phoneNumber === '910000000000' ? 'BRIDGE' : 'WA'}
                      </span>
                    </div>
