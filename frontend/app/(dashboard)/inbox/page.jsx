      ...
      <div className="flex-1 flex flex-col relative bg-[#EFEAE2] z-10 shadow-xl">
        ...
        {!selectedChat ? (
          <div className="flex-1 flex flex-col items-center justify-center bg-[#F0F2F5] p-10 text-center relative z-10">
            <img src="https://img.freepik.com/free-psd/whatsapp-icon-isolated-3d-render-illustration_47987-9785.jpg?t=st=1777375345~exp=1777378945~hmac=1b422e91b6f3780275ad064c3060fc6f4fd905f2895bb7b6f586f3dc40ae4f14&w=1480" className="w-64 h-64 mb-10 object-cover rounded-full border border-slate-200" />
